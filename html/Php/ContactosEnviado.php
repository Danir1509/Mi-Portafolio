...
<body>
		...
		$sql="insert into contactos (Nombre, Apellido, Comentario) values ('$nom','$ape','$comen')";
		$resultado=mysqli_query($conexion,$sql);
		if($resultado)
		{
			//Si es verdadero significa que insert se ejecuto con exito
		mysqli_insert_id($conexion);
		echo"<video  src='Img/Contac/fondo.mp4' autoplay loop muted poster='Img/Contac/fondo.png'></video>";
		echo"
			<!------------------------------------- barra de inicio ------------------------------------->
			<div class='barra'>
		...
		";
		echo "<center style='color:white'>Su Comentario fue enviado con &eacute;xito </center><br>";
		echo "
			<center>
			<form name='formulario' class='registrer' method='POST' action='ContactosEnviado.php'>
				<h3>Contactenos</h3>
				<label for='nomb'>Nombre:</label>
				<br>
				<input type='txt' class='txt' id='nombre' name='nombre'  placeholder='Escriba su nombre' required >
				<br>
				<label for='ape'>Apellido:</label>
				<br>
				<input type='txt' class='txt' id='apelli' name='apellido' placeholder='Escriba su apellido'  required>
				<!--<br>
				<label for='importar'>Ingrese una imagen o documento de lo que sucede:</label>
				<br>
				<input type='file' class='file' name='archi' id='apelli'>&nbsp;
				--><br><br>
				<label for='comen'>Ingrese un comentario:</label>
				<br>
				<textarea name='comentario' required minlength='5' maxlength='250'></textarea>
				<br>
		...
		";
		echo "<br><center style='color: white;'>No se pudo enviar su comentario<br></center>";
		echo "<center style='color: white;'>Vuelva a intentarlo ingresando su consulta o problema nuevamente... </center>";
		echo"<video  src='Img/Contac/fondo.mp4' autoplay loop muted poster='Img/Contac/fondo.png'></video>";
		echo "
			<center>
			<form name='formulario' class='registrer' method='POST' action='ContactosEnviado.php'>
				...
				<input type='file' class='file' name='archi' id='apelli'>&nbsp;
				--><br>
				<label for='importar'>Ingrese un comentario:</label>
				<br>
				<textarea name='comentario' required minlength='5' maxlength='250'></textarea>
				<br>
				<input type='submit' class= 'enviar' id='enviar'  value='Enviar' >
